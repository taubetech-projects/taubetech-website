      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div
              data-animate
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#10B981]/15 border border-[#10B981]/25 text-[#10B981] text-xs sm:text-sm font-semibold mb-6 animate-pulse shadow-sm shadow-[#10B981]/5"
            >
              {t("hero.eyebrow")}
            </div>
            ...
            <h1
              data-animate
              className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-white mb-6 leading-tight max-w-2xl"
            >
          ...
          <div data-animate className="lg:col-span-5 relative w-full flex items-center justify-center min-h-[380px] lg:min-h-[480px]">
            ...
            <div className="absolute w-[220px] h-[220px] rounded-full bg-gradient-to-tr from-blue-600/20 to-indigo-600/20 border border-white/5 flex items-center justify-center animate-[pulse_6s_infinite_alternate] shadow-2xl shadow-blue-500/5">
              <div className="w-[140px] h-[140px] rounded-full bg-[#1B2A4A]/60 border border-white/10 flex items-center justify-center">
                ...
                >
                  ...
                  <path d="M28 6 L18 14 L24 22 L28 6 Z" fill="url(#heroLogoGrad)" opacity="0.9" />
                  <path d="M18 14 L6 18 L14 26 L18 14 Z" fill="url(#heroLogoGrad)" />
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-[#94A3B8] uppercase font-bold tracking-wider">Efficiency</p>
                  <h4 className="text-xs sm:text-sm font-bold text-white leading-tight mt-0.5">{t("hero.float_stat1")}</h4>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-[#94A3B8] uppercase font-bold tracking-wider">Success</p>
                  <h4 className="text-xs sm:text-sm font-bold text-white leading-tight mt-0.5">{t("hero.float_stat2")}</h4>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-[#94A3B8] uppercase font-bold tracking-wider">Compliance</p>
                  <h4 className="text-xs sm:text-sm font-bold text-white leading-tight mt-0.5">{t("hero.float_stat3")}</h4>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-16 lg:hidden relative z-10">
          ...
          >
            ...
            <div>
              <p className="text-[10px] text-[#94A3B8] uppercase font-bold tracking-wider">Efficiency</p>
              <h4 className="text-xs sm:text-sm font-bold text-white mt-0.5">{t("hero.float_stat1")}</h4>
            </div>
          </div>
          <div
            className="bg-[#1E293B]/70 backdrop-blur-md border border-white/10 p-4 rounded-xl shadow-lg flex items-center gap-3"
          ...
          >
            ...
            <div>
              <p className="text-[10px] text-[#94A3B8] uppercase font-bold tracking-wider">Success</p>
              <h4 className="text-xs sm:text-sm font-bold text-white mt-0.5">{t("hero.float_stat2")}</h4>
            </div>
          </div>
          <div
            className="bg-[#1E293B]/70 backdrop-blur-md border border-white/10 p-4 rounded-xl shadow-lg flex items-center gap-3"
          ...
          >
            ...
            <div>
              <p className="text-[10px] text-[#94A3B8] uppercase font-bold tracking-wider">Compliance</p>
              <h4 className="text-xs sm:text-sm font-bold text-white mt-0.5">{t("hero.float_stat3")}</h4>
            </div>
          </div>
        </div>
